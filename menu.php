...
<nav class="sidebar" aria-label="Navegação principal">
  <a class="icon <?= $current==='admin.php' ? 'icon--active' : '' ?>" href="admin.php" title="Dashboard">
    <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3 2 12h3v9h6v-6h2v6h6v-9h3z"/></svg>
  </a>
  <a class="icon <?= $current==='clientes.php' ? 'icon--active' : '' ?>" href="clientes.php" title="Clientes">
  ...
  <a class="icon <?= $current==='produtos.php' ? 'icon--active' : '' ?>" href="produtos.php" title="Produtos">
    <svg viewBox="0 0 24 24"><path d="M21 7H3l3-4h12l3 4zM3 9h18v10H3z"/></svg>
  </a>
  <a class="icon <?= $current==='servicos.php' ? 'icon--active' : '' ?>" href="servicos.php" title="Serviços">
  ...
  <a class="icon <?= $current==='fornecedores.php' ? 'icon--active' : '' ?>" href="fornecedores.php" title="Fornecedores">
  ...
  <a class="icon" href="logout.php" title="Sair">
    <svg viewBox="0 0 24 24"><path d="M16 13v-2H7V8l-5 4 5 4v-3zM20 3h-8v2h8v14h-8v2h8a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2z"/></svg>
  </a>
</nav>
